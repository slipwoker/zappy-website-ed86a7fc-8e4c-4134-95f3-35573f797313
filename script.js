    ...
    function validateField(field) {
      ...
      if (field.dataset.minlength) {
        if (!validators.minLength(value, field.dataset.minlength)) {
          showError(field, errorMessages.minLength + ' (min ' + field.dataset.minlength + ' characters)');
          return false;
        }
      }
      ...
      if (field.hasAttribute('minlength')) {
        ...
        if (!validators.minLength(value, minLen)) {
          showError(field, errorMessages.minLength + ' (min ' + minLen + ' characters)');
          return false;
        }
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Popa culo משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ed86a7fc-8e4c-4134-95f3-35573f797313',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ed86a7fc-8e4c-4134-95f3-35573f797313';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ed86a7fc-8e4c-4134-95f3-35573f797313';
